...
class StudentPerevot extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['user_id', 'student_id', 'edu_direction_id', 'direction_id', 'direction_course_id', 'course_id', 'language_id', 'edu_type_id', 'edu_form_id', 'file_status', 'status', 'created_at', 'updated_at', 'created_by', 'updated_by', 'is_deleted'], 'integer'],
            [['file'], 'string', 'max' => 255],
