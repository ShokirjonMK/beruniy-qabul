...
<table width="100%" style="font-family: 'Times New Roman'; font-size: 20px; border-collapse: collapse;">
    ...
    <tr>
        <td colspan="4" style="vertical-align: top">
            ...
            <b>H/R:</b> _________________________________________________________________________________ <br>
            <b>Bank kodi (MFO):</b> ___________________________________________________________________________ <br>
            <b>STIR (INN):</b> ________________________________________________________________________________ <br>
            <b>Telefon:</b> ___________________________________________________________________________________ <br>
